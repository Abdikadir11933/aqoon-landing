...
- reusable PII-free scenario tables and matching logic are triggered after every completed interview. At the 31 Aug 2026 audit, production contains four `family_scenarios` and four `family_scenario_research` records; operators must still verify any route before reuse.
