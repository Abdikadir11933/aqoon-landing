...
caawi/ page that's missing them. Run once, inspect the diff, then delete or
keep for reference - not part of the ongoing QA pipeline."""
import glob
import json
import re

FILES = sorted(glob.glob('caawi/*/index.html'))
...
SKIP_JSONLD = {'caawi/tietosuoja/index.html', 'caawi/disclaimer/index.html'}
