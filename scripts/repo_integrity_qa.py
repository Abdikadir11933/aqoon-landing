...
required = [
    ...
    "scripts/generate_tracker_contract_inventory.mjs",
    "tests/tracker-contract-inventory.test.js",
    "docs/architecture/generated-tracker-contract-inventory.json",
