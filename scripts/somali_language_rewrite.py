...
PER_FILE = {
    ...
    "caawi/sababta-aqoon/index.html": {
...
for path in TARGETS:
    ...
    # Do not touch protected Pilke campaign content if it is ever moved under Caawi.
